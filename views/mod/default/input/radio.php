<?php
    ...
    foreach($vars['options'] as $label => $option) {
        ...
        echo "<label class=\"genusers-label\"><input type=\"radio\" $disabled {$vars['js']} name=\"{$vars['internalname']}\" value=\"".htmlentities($option, null, 'UTF-8')."\" {$selected} class=\"$class\" />{$label}</label><br />";
    }
