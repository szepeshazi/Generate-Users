...
$mysqldump_field = elgg_view('input/text', array('internalname' => 'path_to_mysqldump', 'value' => '' ));

$users_number_label = elgg_echo('users:number');
$users_number_field = elgg_view('input/text', array('internalname' => 'numofusers', 'value' => '50' ));
$users_prefix_label = elgg_echo('users:prefix');
$users_prefix_field = elgg_view('input/text', array('internalname' => 'userprefix', 'value' => 'user'));
...
$users_createicons_field = elgg_view('input/checkboxes', array('internalname' => 'createicons', 'value' => '1' ,'options' => array(' ' => '1')));
...
$users_friends_field = elgg_view('input/text', array('internalname' => 'numoffriends', 'value' => '5'));
...
$users_mails_field = elgg_view('input/text', array('internalname' => 'numofemails', 'value' => '5'));
...
$users_blogs_field = elgg_view('input/text', array('internalname' => 'numofblogs',  'value' => '1'));
$users_blogcomments_label = elgg_echo('users:blogcomments');
$users_blogcomments_field = elgg_view('input/text', array('internalname' => 'numofblogcomments',  'value' => '1'));
...
$users_uploads_field = elgg_view('input/text', array('internalname' => 'numofuploads', 'value' => '2'));
$users_uploadcomments_label = elgg_echo('users:uploadcomments');
$users_uploadcomments_field = elgg_view('input/text', array('internalname' => 'numofuploadcomments', 'value' => '2'));

// JMeter test parameters display section
$jmeter_dojmeter_label = elgg_echo('jmeter:dotest');
$jmeter_dojmeter_field = elgg_view('input/checkboxes', array('internalname' => 'dojmeter', 'value' => '1' ,'options' => array(' ' => '1')));
...
$generate = elgg_view('input/submit', array('value' => elgg_echo('users:generate'), 'internalid' => 'gensubmit'));
...
$progress_bg = $site_url."mod/hu_skawa_genusers/js/jquery.progressbar/images/progressbar.gif";
$progress_yellow = $site_url."mod/hu_skawa_genusers/js/jquery.progressbar/images/progressbg_yellow.gif";
$progress_green = $site_url."mod/hu_skawa_genusers/js/jquery.progressbar/images/progressbg_green.gif";
...
echo elgg_view('input/form', array('action' => "{$vars['url']}action/hu_skawa_genusers/generate", "internalid" => "genform", "method" => "post", "body" => $gen_form));
