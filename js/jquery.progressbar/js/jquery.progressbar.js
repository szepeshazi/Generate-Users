	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage	: '/mod/hu_skawa_genusers/js/jquery.progressbar/images/progressbar.gif',						// boxImage : image around the progress bar
				barImage	: {
								0:	'/mod/hu_skawa_genusers/js/jquery.progressbar/images/progressbg_yellow.gif',
								100: '/mod/hu_skawa_genusers/js/jquery.progressbar/images/progressbg_green.gif'
