<?php
	...
	$english = array(
		...
		'mysqldump:path' => 'Path to you mysqldump command (like /usr/bin/ or C:/Program Files/MySQL/bin/)',
		'mysql:path' => 'Path to you mysql command (like /usr/bin/ or C:/Program Files/MySQL/bin/, only for fast deletion)',
		...
		'messages:success' => "Users succesfully generated with user identifiers from \"%s\" to \"%s\" in %s seconds.",
